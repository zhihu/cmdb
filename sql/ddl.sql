...
CREATE TABLE object_log (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  object_id BIGINT UNSIGNED NOT NULL,
  level TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0: EMERGENCY 1: ALERT 2: CRITICAL 3: ERROR 4: WARNING 5: NOTICE 6: INFORMATIONAL 7: DEBUG 8: NOTE',
  format TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0: text/plain 1: application/json',
  source TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0: INTERNAL 1: API 2: USER 3: SYSTEM',
...
CREATE TABLE object_relation (
  ...
  relation_type_id MEDIUMINT UNSIGNED NOT NULL,
...
CREATE TABLE object_relation_meta (
  ...
  delete_time TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY(id),
  UNIQUE KEY(relation_type_id, name)
) ENGINE=InnoDB CHARSET utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE object_relation_meta_value (
  ...
  update_time TIMESTAMP NULL DEFAULT NULL,
  delete_time TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY(from_object_id, relation_type_id, to_object_id, meta_id),
  INDEX(delete_time, from_object_id, relation_type_id, to_object_id, meta_id)
) ENGINE=InnoDB CHARSET utf8mb4 COLLATE=utf8mb4_bin;
